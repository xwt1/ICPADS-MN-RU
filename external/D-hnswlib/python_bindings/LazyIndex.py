import hnswlib
"""
    A python wrapper for lazy indexing, preserves the same api as D-hnswlib.Index but initializes the index only after adding items for the first time with `add_items`.
"""
