...
PYBIND11_PLUGIN(hnswlib) {
        ...
        .def("__repr__", [](const Index<float> &a) {
            return "<D-hnswlib.Index(space='" + a.space_name + "', dim="+std::to_string(a.dim)+")>";
        });
        ...
        .def("__repr__", [](const BFIndex<float> &a) {
            return "<D-hnswlib.BFIndex(space='" + a.space_name + "', dim="+std::to_string(a.dim)+")>";
        })
