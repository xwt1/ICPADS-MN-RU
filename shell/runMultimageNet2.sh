...
programs=(
  "edge_connected_replaced_update_7_full_coverage_imageNet2"
  "edge_connected_replaced_update_8_full_coverage_imageNet2"
  "edge_connected_replaced_update_9_full_coverage_imageNet2"
  "edge_connected_replaced_update_10_full_coverage_imageNet2"
  "replaced_update_full_coverage_imageNet2"
)
