...
int main(int argc, char* argv[]){
    ...
    std::string output_csv_path = root_path + "/output/figure_3/imageNet/mark_delete.csv";
    std::string output_index_path = root_path + "/output/figure_3/imageNet/mark_imageNet_after_mult_index.bin";
