...
//    std::string index_path = root_path + "/data/sift/hnsw_maintenance/sift_hnsw_maintenance_index.bin";
    ...
    std::string output_csv_path = root_path + "/output/figure_3/sift/method9_direct_delete.csv";
    std::string output_index_path = root_path + "/output/figure_3/sift/method9_sift_after_mult_index.bin";
