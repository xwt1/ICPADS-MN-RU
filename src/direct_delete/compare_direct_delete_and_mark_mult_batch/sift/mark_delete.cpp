...
int main(int argc, char* argv[]){
    ...
    std::string output_csv_path = root_path + "/output/figure_3/sift/mark_delete.csv";
    std::string output_index_path = root_path + "/output/figure_3/sift/mark_sift_after_mult_index.bin";
