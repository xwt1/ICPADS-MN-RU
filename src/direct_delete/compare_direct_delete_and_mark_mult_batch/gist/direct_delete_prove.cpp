...
//    std::string output_csv_path = root_path + "/output/figure_3/gist/direct_delete.csv";
    ...
    std::string output_csv_path = root_path + "/output/figure_3/gist/direct_delete_method9.csv";
    std::string output_index_path = root_path + "/output/figure_3/gist/method9_gist_after_mult_index.bin";
