...
int main(int argc, char* argv[]){
    ...
    std::string output_csv_path = root_path + "/output/figure_5/sift_2M/mark_delete.csv";

    std::string output_index_path = root_path + "/output/figure_5/sift_2M/mark_sift2M_index.bin";
