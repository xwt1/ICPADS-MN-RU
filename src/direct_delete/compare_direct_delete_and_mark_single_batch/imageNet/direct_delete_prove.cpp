...
//    std::string output_csv_path = root_path + "/output/figure_4/imageNet/direct_delete.csv";
    std::string output_csv_path = root_path + "/output/figure_11_test_unreachable2/imageNet/direct_delete.csv";
    ...
    auto results = directDeleteUtil::query_index(&index, queries_tmp, data_siz);
