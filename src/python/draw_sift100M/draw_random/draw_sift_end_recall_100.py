...
if __name__ == "__main__":
    ...
    # 定义CSV文件的根目录和图像的输出路径
    csv_dir = os.path.join(args.root_path, 'output', 'sift_200M', 'random')
    output_path = os.path.join(args.root_path, 'output', 'sift_200M', 'random', 'random_sift_100M_end_recall_100.pdf')
