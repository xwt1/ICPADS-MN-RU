...
if __name__ == "__main__":
    ...
    # 定义CSV文件的根目录和图像的输出路径
    csv_dir = os.path.join(args.root_path, 'output', 'sift_200M', 'full_coverage')
    output_path = os.path.join(args.root_path, 'output', 'sift_200M', 'full_coverage', 'full_coverage_sift_100M_end_recall_100.pdf')
    ...
    csv_files = [
        ...
        'faiss_end_recall_sift_100M.csv'
    ]
    # 手动编码的颜色和点的形状
