...
if __name__ == "__main__":
    ...
    output_path = os.path.join(args.root_path, 'output', 'random', 'imageNet', 'random_imageNet_2M_end_recall.pdf')

    # 手动编码的CSV文件名列表
    csv_files = [
        'edge_connected_9_end_recall_imageNet_2M.csv',
        'edge_connected_10_end_recall_imageNet_2M.csv',
