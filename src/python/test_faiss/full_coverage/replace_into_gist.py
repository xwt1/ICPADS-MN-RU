...
#
# # 文件路径
# base_path = root_path + '/data/gist/gist_base.fvecs'
# query_path = root_path + '/data/gist/gist_query.fvecs'
# ground_truth_path = root_path + '/data/gist/gist_groundtruth.ivecs'
# index_path = '/home/xiaowentao/WorkSpace/training-plan/dockerimages/delete_update/retrieval-diversity-enhancement/data/gist/faiss_index/gist_index.bin'
#
#
# # 读取 fvecs 格式的文件
...
# time_values = []
# k = 100  # 查询时要返回的最近邻向量数
# start_nprobe = 50  # 从最大的 nlist 开始，确保 recall 较高
#
...
time_values = []
k = 100  # 查询时要返回的最近邻向量数
start_nprobe = 100  # 从最大的 nlist 开始，确保 recall 较高
...
# 执行一次完整查询后，计算平均速度和总的recall
for nprobe in range(start_nprobe, 99, -1):  # 从较高的 nprobe 值开始逐渐减小
    index.nprobe = nprobe
