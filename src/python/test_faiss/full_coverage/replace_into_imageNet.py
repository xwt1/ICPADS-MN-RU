...
# 文件路径
base_path = root_path + '/data/imageNet/image.ds'
query_path = root_path + '/data/imageNet/image.q'
ground_truth_path = root_path + '/data/imageNet/imageNet_groundtruth.ivecs'
