...
if __name__ == "__main__":
    ...
    # 定义CSV文件的根目录和图像的输出路径
    csv_dir = os.path.join(args.root_path, 'output', 'full_coverage', 'sift')
    output_path = os.path.join(args.root_path, 'output', 'full_coverage', 'sift', 'full_coverage_sift_1M_end_recall_100.pdf')
