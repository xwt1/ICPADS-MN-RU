...
int main() {
    // 参数设置
    std::string data_path = "/home/xiaowentao/WorkSpace/training-plan/dockerimages/delete_update/retrieval-diversity-enhancement/data/imageNet/image.ds";
    std::string save_dir = "/home/xiaowentao/WorkSpace/training-plan/dockerimages/delete_update/retrieval-diversity-enhancement/data/imageNet/faiss_index/";
    std::string save_path = save_dir + "imageNet_index.bin";
