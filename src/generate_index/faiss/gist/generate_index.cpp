...
int main() {
    // 参数设置
    std::string data_path = "/home/xiaowentao/WorkSpace/training-plan/dockerimages/delete_update/retrieval-diversity-enhancement/data/gist/gist_base.fvecs";
    std::string save_dir = "/home/xiaowentao/WorkSpace/training-plan/dockerimages/delete_update/retrieval-diversity-enhancement/data/gist/faiss_index/";
    std::string save_path = save_dir + "gist_index.bin";
