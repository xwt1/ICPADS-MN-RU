...
int main() {
    const std::string index_file = "/home/xiaowentao/WorkSpace/training-plan/dockerimages/retrieval-diversity-enhancement/data/sift/new_level_selection_index/sift_index_new_level_selection_100000.bin";
//    const std::string index_file = "/home/xiaowentao/WorkSpace/training-plan/dockerimages/retrieval-diversity-enhancement/data/sift/new_level_selection_index/sift_index_new_level_selection_prime_100000.bin";
...
//    hnswlib::HierarchicalNSW<float> index(&space, max_elements, M, ef_construction);
    hnswlib::HierarchicalNSW<float> index(&space, index_file,false);
...
//    }
    ...
    // 保存索引到文件
//    index.saveIndex("/home/xiaowentao/WorkSpace/training-plan/dockerimages/retrieval-diversity-enhancement/data/sift/new_level_selection_index/sift_index_new_level_selection_prime_100000.bin");
