...
//    std::string query_data_path = root_path + "/data/netflix/netflix_query.fvecs";
//    std::string ground_truth_path = root_path + "/data/netflix/netflix_groundtruth.ivecs";
//
//    std::vector<std::string> paths_to_create ={data_path,query_data_path,ground_truth_path};
...
int main(int argc, char* argv[]) {
    ...
    std::string data_path = root_path + "/data/netflix/netflix_base.fvecs";
    std::string query_data_path = root_path + "/data/netflix/netflix_query_all.fvecs";
    std::string ground_truth_path = root_path + "/data/netflix/netflix_groundtruth.ivecs";
