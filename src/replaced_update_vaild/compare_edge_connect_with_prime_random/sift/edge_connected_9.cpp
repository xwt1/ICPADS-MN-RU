...
int main(int argc, char* argv[]){
    ...
    std::string output_csv_path = root_path + "/output/random/sift/edge_connected_9.csv";
    std::string output_index_path = root_path + "/output/random/sift/edge_connected_9_sift_random_index.bin";
