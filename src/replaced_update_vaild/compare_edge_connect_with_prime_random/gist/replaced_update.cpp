...
int main(int argc, char* argv[]){
    ...
    std::string output_csv_path = root_path + "/output/random/gist/replaced_update.csv";
    std::string output_index_path = root_path + "/output/random/gist/replaced_update_gist_random_index.bin";
