...
int main(int argc, char* argv[]) {
    ...
    std::string output_csv_path = root_path + "/output/random/gist/faiss_ivf_flat.csv";
    std::string output_index_path = root_path + "/output/random/gist/faiss_gist_output_index.bin";
