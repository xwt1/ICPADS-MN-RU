...
int main(int argc, char* argv[]){
    ...
    std::string output_csv_path = root_path + "/output/random/gist/edge_connected_7.csv";
    std::string output_index_path = root_path + "/output/random/gist/edge_connected_7_gist_random_index.bin";
