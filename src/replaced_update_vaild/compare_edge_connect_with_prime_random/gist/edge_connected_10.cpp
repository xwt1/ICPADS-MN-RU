...
int main(int argc, char* argv[]){
    ...
    std::string random_indice_path = root_path + "/data/gist/gist_random_data.ivecs";
    std::string output_csv_path = root_path + "/output/random/gist/edge_connected_10.csv";
    std::string output_index_path = root_path + "/output/random/gist/edge_connected_10_gist_random_index.bin";
