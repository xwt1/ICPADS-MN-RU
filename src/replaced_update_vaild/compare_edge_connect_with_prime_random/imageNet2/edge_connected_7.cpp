...
int main(int argc, char* argv[]){
    ...
    std::string random_indice_path = root_path + "/data/imageNet2/imageNet_random_data.ivecs";
    std::string output_csv_path = root_path + "/output/random/imageNet2/edge_connected_7.csv";
    std::string output_index_path = root_path + "/output/random/imageNet2/edge_connected_7_imageNet_random_index.bin";
