...
//    std::string ground_truth_path = root_path + "/data/gist/gist_groundtruth.ivecs";
    ...
    std::vector <std::vector <std::string>> csv_index_path_vec={
        ...
        {root_path + "/output/full_coverage/imageNet2/edge_connected_7.csv",
         root_path + "/output/full_coverage/imageNet2/edge_connected_7_imageNet_random_index.bin",
                root_path + "/data/imageNet/image.ds",
                root_path + "/data/imageNet/image.q",
                root_path + "/data/imageNet/imageNet_groundtruth.ivecs"},
        {root_path + "/output/full_coverage/imageNet2/edge_connected_8.csv",
         root_path + "/output/full_coverage/imageNet2/edge_connected_8_imageNet_random_index.bin",
                root_path + "/data/imageNet/image.ds",
                root_path + "/data/imageNet/image.q",
                root_path + "/data/imageNet/imageNet_groundtruth.ivecs"},
        {root_path + "/output/full_coverage/imageNet2/edge_connected_9.csv",
         root_path + "/output/full_coverage/imageNet2/edge_connected_9_imageNet_random_index.bin",
                root_path + "/data/imageNet/image.ds",
                root_path + "/data/imageNet/image.q",
                root_path + "/data/imageNet/imageNet_groundtruth.ivecs"},
        {root_path + "/output/full_coverage/imageNet2/edge_connected_10.csv",
         root_path + "/output/full_coverage/imageNet2/edge_connected_10_imageNet_random_index.bin",
                root_path + "/data/imageNet/image.ds",
                root_path + "/data/imageNet/image.q",
                root_path + "/data/imageNet/imageNet_groundtruth.ivecs"},
            {root_path + "/output/full_coverage/imageNet2/replaced_update.csv",
             root_path + "/output/full_coverage/imageNet2/replaced_update_imageNet_random_index.bin",
             root_path + "/data/imageNet/image.ds",
             root_path + "/data/imageNet/image.q",
             root_path + "/data/imageNet/imageNet_groundtruth.ivecs"},
