...
int main(int argc, char* argv[]){
    ...
    std::string output_csv_path = root_path + "/output/random/imageNet2/edge_connected_10.csv";
    std::string output_index_path = root_path + "/output/random/imageNet2/edge_connected_10_imageNet_random_index.bin";
