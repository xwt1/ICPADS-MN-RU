...
int main(int argc, char* argv[]) {
    ...
    std::string output_csv_path = root_path + "/output/random/imageNet/faiss_ivf_flat.csv";
    std::string output_index_path = root_path + "/output/random/imageNet/faiss_imageNet_output_index.bin";
