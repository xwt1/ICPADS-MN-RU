...
int main(int argc, char* argv[]) {
    ...
    std::string output_csv_path = root_path + "/output/full_coverage/sift/faiss_ivf_flat.csv";
    std::string output_index_path = root_path + "/output/full_coverage/sift/faiss_sift_output_index.bin";
