...
int main(int argc, char* argv[]) {
    ...
    std::string output_csv_path = root_path + "/output/full_coverage/imageNet2/faiss_ivf_flat.csv";
    std::string output_index_path = root_path + "/output/full_coverage/imageNet2/faiss_imageNet_output_index.bin";
...
//    std::cout<<"wtf: "<<num_queries<<std::endl;
    ...
    std::cout<<ground_truth[0].size()<<std::endl;
