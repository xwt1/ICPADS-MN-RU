...
int main(int argc, char* argv[]){
    ...
    std::string output_csv_path = root_path + "/output/full_coverage/imageNet2/edge_connected_replaced_update8.csv";
    std::string output_index_path = root_path + "/output/full_coverage/imageNet2/edge_connected_replaced_update8_imageNet_full_coverage_index.bin";
