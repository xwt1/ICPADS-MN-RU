...
//    std::string ground_truth_path = root_path + "/data/gist/gist_groundtruth.ivecs";
    ...
    std::vector <std::vector <std::string>> csv_index_path_vec={
        {root_path + "/output/full_coverage/imageNet/edge_connected_replaced_update9_end_recall_imageNet_2M.csv",
        ...
        {root_path + "/output/full_coverage/imageNet/edge_connected_replaced_update10_end_recall_imageNet_2M.csv",
         root_path + "/output/full_coverage/imageNet/edge_connected_replaced_update10_imageNet_full_coverage_index.bin",
                root_path + "/data/imageNet/image.ds",
                root_path + "/data/imageNet/image.ds",
                root_path + "/data/imageNet/imageNet_2M_groundtruth.ivecs"},
        {root_path + "/output/full_coverage/imageNet/replaced_update_end_recall_imageNet_2M.csv",
