...
int main(int argc, char* argv[]){
    ...
    std::string output_csv_path = root_path + "/output/full_coverage/word2vec/replaced_update.csv";
    std::string output_index_path = root_path + "/output/full_coverage/word2vec/replaced_update_word2vec_full_coverage_index.bin";
