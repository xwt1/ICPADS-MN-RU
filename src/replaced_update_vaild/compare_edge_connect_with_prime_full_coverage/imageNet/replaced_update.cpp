...
int main(int argc, char* argv[]){
    ...
    std::string output_csv_path = root_path + "/output/full_coverage/imageNet/replaced_update.csv";
    std::string output_index_path = root_path + "/output/full_coverage/imageNet/replaced_update_imageNet_full_coverage_index.bin";
