...
int main(int argc, char* argv[]){
    ...
    std::string output_csv_path = root_path + "/output/new_insert/sift_2M/replaced_update.csv";

    std::string output_index_path = root_path + "/output/new_insert/sift_2M/replaced_update_sift_2M_new_insert_index.bin";
