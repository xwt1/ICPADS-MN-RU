...
//    std::string index_path = root_path + "/data/sift_2M/hnsw_maintenance/sift2M_hnsw_maintenance_index.bin";
    ...
    std::string output_csv_path = root_path + "/output/new_insert/sift_2M/edge_connected_replaced_update8.csv";
    std::string output_index_path = root_path + "/output/new_insert/sift_2M/edge_connected_replaced_update8_sift_2M_new_insert_index.bin";
