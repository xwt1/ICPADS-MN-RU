...
int main(int argc, char* argv[]){
    ...
    std::string output_csv_path = root_path + "/output/random/sift200M/edge_connected_replaced_update9.csv";
    std::string output_index_path = root_path + "/output/random/sift200M/edge_connected_replaced_update9_sift100M_random_index.bin";
