...
//    std::string root_path = argv[1];
    ...
    std::string output_csv_path = root_path + "/output/full_coverage/sift/edge_connected_replaced_update7.csv";
    std::string output_index_path = root_path + "/output/full_coverage/sift/edge_connected_replaced_update7_sift_full_coverage_index.bin";
