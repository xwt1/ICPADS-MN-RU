...
int main(int argc, char* argv[]){
    ...
    std::string output_csv_path = root_path + "/output/random/sift200M/replaced_update.csv";
    std::string output_index_path = root_path + "/output/random/sift200M/replaced_update_sift100M_random_index.bin";
