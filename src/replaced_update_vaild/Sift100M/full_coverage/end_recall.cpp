...
//    std::string ground_truth_path = root_path + "/data/gist/gist_groundtruth.ivecs";
    ...
    std::vector <std::vector <std::string>> csv_index_path_vec={
        {root_path + "/output/full_coverage/sift200M/edge_connected_replaced_update7_end_recall.csv",
         root_path + "/output/full_coverage/sift200M/edge_connected_replaced_update7_sift100M_full_coverage_index.bin",
         root_path + "/sift/bigann_base.bvecs",
         root_path + "/sift/sift200M/bigann_query.bvecs",
         root_path + "/sift/sift200M/gnd/idx_100M.ivecs",},
        {root_path + "/output/full_coverage/sift200M/edge_connected_replaced_update8_end_recall.csv",
                root_path + "/output/full_coverage/sift200M/edge_connected_replaced_update8_sift100M_full_coverage_index.bin",
                root_path + "/sift/bigann_base.bvecs",
                root_path + "/sift/sift200M/bigann_query.bvecs",
                root_path + "/sift/sift200M/gnd/idx_100M.ivecs",},
        {root_path + "/output/full_coverage/sift200M/edge_connected_replaced_update9_end_recall.csv",
         root_path + "/output/full_coverage/sift200M/edge_connected_replaced_update9_sift100M_full_coverage_index.bin",
         root_path + "/sift/bigann_base.bvecs",
         root_path + "/sift/sift200M/bigann_query.bvecs",
         root_path + "/sift/sift200M/gnd/idx_100M.ivecs",},
            {root_path + "/output/full_coverage/sift200M/edge_connected_replaced_update10_end_recall.csv",
             root_path + "/output/full_coverage/sift200M/edge_connected_replaced_update10_sift100M_full_coverage_index.bin",
             root_path + "/sift/bigann_base.bvecs",
             root_path + "/sift/sift200M/bigann_query.bvecs",
             root_path + "/sift/sift200M/gnd/idx_100M.ivecs",},
            {root_path + "/output/full_coverage/sift200M/replaced_update_end_recall.csv",
             root_path + "/output/full_coverage/sift200M/replaced_update_sift100M_full_coverage_index.bin",
             root_path + "/sift/bigann_base.bvecs",
             root_path + "/sift/sift200M/bigann_query.bvecs",
             root_path + "/sift/sift200M/gnd/idx_100M.ivecs",
             },
