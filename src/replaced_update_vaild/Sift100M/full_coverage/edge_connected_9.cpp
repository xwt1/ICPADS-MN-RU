...
int main(int argc, char* argv[]) {
    ...
    std::string output_csv_path = output_path + "/output/full_coverage/sift200M/edge_connected_replaced_update9.csv";
    std::string output_index_path = output_path + "/output/full_coverage/sift200M/edge_connected_replaced_update9_sift100M_full_coverage_index.bin";
