...
int main(int argc, char* argv[]) {
    ...
    std::string query_path = root_path + "/sift/sift100M/bigann_query.bvecs";
    std::string index_path = root_path + "/sift/sift100M/index/faiss_ivf_index.bin";
    std::string ground_truth_path = root_path + "/sift/sift100M/gnd/idx_100M.ivecs";
